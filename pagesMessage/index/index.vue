	...
	<view class="viewBox">
		...
		<view class="stickyContent" :style="{ top: notchHeight + 'px' }">
			<up-tabs
				...
				:inactiveStyle="{ color: '#999999', fontWeight: '400', fontSize: '30rpx' }"
			></up-tabs>
		</view>
		<view v-if="true">
			<view v-for="(item, index) in 10" :key="index" @click="goToPage('/pagesMessage/messageDetails/messageDetails')">
