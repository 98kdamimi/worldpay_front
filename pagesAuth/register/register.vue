	...
	<view class="registerContainer">
		<view class="topBg">
			...
			<SvgIcon
				...
				height="48"
				class="svgClass"
				@click="goToPage('/pagesAuth/login/login')"
			></SvgIcon>
		</view>
...
import { sendEmailCode, signUp } from '@/request/api.js';
