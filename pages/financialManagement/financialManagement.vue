			...
			<view class="list-item" v-for="(item, index) in 3" :key="index">
				<view class="box top displayRow">
					<view class="box-top displayRow">
						...
						<view class="box-top-left">
							...
							<view class="box-top-left-button">
								...
								<view class="green" style="margin-left: 12rpx">
									USDT
								</view>
							</view>
						</view>
					...
					<view class="box-top-right">
						<view>88%</view>
						<view class="box-top-right-txt">
							{{ $t('finance.annualRate') }}
						</view>
					</view>
				</view>
				<view class="box bottom">
					<view class="list-item-txt displayRow">
						...
						<view class="list-item-txt-right">
							{{ $t('finance.onSale') }}
						</view>
					</view>
					<view class="list-item-txt displayRow">
					...
					<view class="item-button" @click="passwordShow = true">
						{{ $t('finance.purchase') }}
					</view>
				</view>
			</view>
		...
		<up-popup :show="passwordShow" mode="bottom" bgColor="#141414">
			<view class="passwordPopup">
				<view class="passwordPopup-title">
					{{ $t('finance.securityVerification') }}
				</view>
...
import { userAssets } from '@/request/lapi.js';
