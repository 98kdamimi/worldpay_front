	...
	<view class="viewBox">
		...
		<view class="kingKong">
			<view
				@click="
					goToPage(
						'/pagesMine/financialManagementOrders/financialManagementOrders'
					)
				"
			>
				<view>
			...
			>
				...
				<view>{{ $t('cardList.applicationRecords') }}</view>
			</view>
			<view
				@click="
					goToPage('/pagesMine/transactionRecords/transactionRecords')
				"
			>
				<view>
					<SvgIcon
			...
			<view
				@click="
					goToPage(
						'/pagesMine/personalInformation/personalInformation'
					)
				"
			>
				<view>
		...
		<view>
			...
			>
				...
				<view>
					<view style="margin-right: 24rpx" v-if="item.right">
						{{ item.right }}
					</view>
